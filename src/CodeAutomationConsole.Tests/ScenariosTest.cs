namespace CodeAutomationConsole.Test
{
    ...
    public class ApplicationTest
    {
        ...
        private readonly string _scenariosPrefix;

        public ApplicationTest()
        {
            _assembly = Assembly.GetExecutingAssembly();
            _scenariosPrefix = $"{_assembly.GetName().Name}.Scenarios.";
        }
        ...
        public void TestScenario()
        {
            ...
            foreach (var scenarioResource in scenarioResources)
            {
                ...
                var scenarioName = scenarioResource.Substring(_scenariosPrefix.Length);
        ...
        private IEnumerable<string> GetAllScenarioResources()
        {
            ...
            return resourceNames.Where(x => x.StartsWith(_scenariosPrefix))
                .OrderBy(x => x);
        }
        ...
        private Process StartConsoleApplication(string arguments)
        {
            ...
            proc.StartInfo.FileName = "CodeAutomationConsole.exe";
