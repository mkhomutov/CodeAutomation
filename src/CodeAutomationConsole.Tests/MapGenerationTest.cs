namespace CodeAutomationConsole.Test
{
    ...
    public class MapGenerationTest
    {
        ...
        public MapGenerationTest()
        {
            ...
            _mapsPrefix = $"{_assembly.GetName().Name}.Classes.";
            _csvPrefix = @"..\..\..\Csv\";
        }
        ...
        {
            var csvResourceFilename = _csvPrefix + name + ".csv";
            var mapResourceFilename = _mapsPrefix + name + ".cs";
            ...
            try
            {
                ...
                AssertMap(name, currentClass, generatedClass);
            }
